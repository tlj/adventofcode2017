...
namespace AdventOfCode2017
{
    public class Day02
    {
        const string input = @"4168	3925	858	2203	440	185	2886	160	1811	4272	4333	2180	174	157	361	1555
...
37	1069	166	1037	172	258	1071	90	497	1219	145	1206	143	153	1067	510";
        ...
        {
            var lines = Input.StringToListsOfInt(input, "\t");

            var checksum = 0;
            foreach (var l in lines)
            {
                checksum += l.Max(p => p) - l.Min(p => p);
            }
            
            Console.WriteLine("Day 2 Part 1: {0}", checksum);
        }
...
3 8 6 5";
            ...
            Console.WriteLine("Day 2 Part 2: {0}", checksum);
        }
    }
