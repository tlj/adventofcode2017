...
namespace AdventOfCode2017
{
    public class Day04
    {
        private const string input = @"kvvfl kvvfl olud wjqsqa olud frc
...
rvbu czwpdit vmlihg spz lfaxxev zslfuto oog dvoksub";
        ...
        public static void Part1()
        {
            ...
            Console.WriteLine("Day 4 part 1: {0}", c);
        }
        ...
        public static void Part2()
        {
            ...
            foreach (var line in input.Split(Environment.NewLine))
            {
                ...
                {
                    codes[i] = Input.SortString(codes[i]);
                }
            ...
            Console.WriteLine("Day 4 part 2: {0}", c);
        }
    }
}